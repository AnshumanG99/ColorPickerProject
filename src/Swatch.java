...
//		String hexadecimal = Integer.toHexString(decimal);
	...
	public String getHexString()
	{
		...
		rrggbb += decimalToHex(v0) + decimalToHex(v1);
		...
		rrggbb += decimalToHex(v0) + decimalToHex(v1);
//		String rHex = decimalToHex(myRed.getShade());7
//		String gHex = decimalToHex(myGreen.getShade());
//		String bHex = decimalToHex(myBlue.getShade());
